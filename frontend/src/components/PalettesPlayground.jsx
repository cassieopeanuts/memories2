...
const themes = [
  ...
  { 
    id: 'black-peony', 
    name: 'Черный Пион 🖤', 
    desc: 'Премиальная темная палитра на основе пионовых тонов: глубокий prune-фон и яркие неоновые лепестки пиона.',
    colors: [
      { name: 'Фон (50)', hex: '#110b0d' },
      { name: 'Карточки (100)', hex: '#1c1215' },
      { name: 'Мягкий акцент (200)', hex: '#382025' },
      { name: 'Доп. акцент (300)', hex: '#572f37' },
      { name: 'Приглушенный текст (400)', hex: '#7b4c56' },
      { name: 'Основной бренд (500)', hex: '#d95c7b' },
      { name: 'Ховер бренда (600)', hex: '#be4661' },
      { name: 'Активный бренд (700)', hex: '#a3344c' },
      { name: 'Темный акцент (800)', hex: '#f5d5dd' },
      { name: 'Основной текст (900)', hex: '#FAF5F6' }
    ]
  },
  { 
    id: 'flamingo', 
    name: 'Розовый фламинго 🦩', 
    desc: 'Экзотическое и глубокое сочетание цветов оперения фламинго: оттенки пурпура, пудровой пыли и глубокого черного.',
    colors: [
      { name: 'Фон (50)', hex: '#F7F2F1' },
      { name: 'Карточки (100)', hex: '#c5bbba' },
      { name: 'Мягкий акцент (200)', hex: '#c685b2' },
      { name: 'Доп. акцент (300)', hex: '#a97f75' },
      { name: 'Приглушенный текст (400)', hex: '#8f7570' },
      { name: 'Основной бренд (500)', hex: '#733651' },
      { name: 'Ховер бренда (600)', hex: '#632b43' },
      { name: 'Активный бренд (700)', hex: '#522135' },
      { name: 'Темный акцент (800)', hex: '#2A2526' },
      { name: 'Основной текст (900)', hex: '#000000' }
    ]
  },
  { 
    id: 'peony2', 
    name: 'Пеон 2 🪷', 
    desc: 'Классическая вариация темы Пеон с более естественными, спокойными и высококонтрастными тонами для комфортного чтения.',
    colors: [
      { name: 'Фон (50)', hex: '#FCF8F9' },
      { name: 'Карточки (100)', hex: '#F5DFE4' },
      { name: 'Мягкий акцент (200)', hex: '#c27a92' },
      { name: 'Доп. акцент (300)', hex: '#ab5e75' },
      { name: 'Приглушенный текст (400)', hex: '#6e6064' },
      { name: 'Основной бренд (500)', hex: '#8a2b40' },
      { name: 'Ховер бренда (600)', hex: '#752033' },
      { name: 'Активный бренд (700)', hex: '#611727' },
      { name: 'Темный акцент (800)', hex: '#3b2c30' },
      { name: 'Основной текст (900)', hex: '#1c1214' }
    ]
  },
  { 
    id: 'marshmallow', 
    name: 'Нежный зефир ☕', 
    desc: 'Уютная палитра на основе зефирного какао: нежные молочно-розовые зефирки, теплая серая кружка и благородный темный сливовый акцент.',
    colors: [
      { name: 'Фон (50)', hex: '#FAF6F8' },
      { name: 'Карточки (100)', hex: '#eed1e2' },
      { name: 'Мягкий акцент (200)', hex: '#ae84a0' },
      { name: 'Доп. акцент (300)', hex: '#b2b3b2' },
      { name: 'Приглушенный текст (400)', hex: '#8f6480' },
      { name: 'Основной бренд (500)', hex: '#7f2852' },
      { name: 'Ховер бренда (600)', hex: '#6e2045' },
      { name: 'Активный бренд (700)', hex: '#5b1838' },
      { name: 'Темный акцент (800)', hex: '#2A2A38' },
      { name: 'Основной текст (900)', hex: '#0a0a18' }
    ]
  },
  {
    id: 'dark-classic',
    name: 'Темная Классика 🖤',
    desc: 'Темная версия классической палитры: глубокие коричневые и кофейные тона с мягким персиково-розовым брендом.',
    colors: [
      { name: 'Фон (50)', hex: '#120d08' },
      { name: 'Карточки (100)', hex: '#1d1610' },
      { name: 'Мягкий акцент (200)', hex: '#33251c' },
      { name: 'Доп. акцент (300)', hex: '#4a3528' },
      { name: 'Приглушенный текст (400)', hex: '#705342' },
      { name: 'Основной бренд (500)', hex: '#ca727f' },
      { name: 'Ховер бренда (600)', hex: '#b8626e' },
      { name: 'Активный бренд (700)', hex: '#a3535f' },
      { name: 'Темный акцент (800)', hex: '#f7e5db' },
      { name: 'Основной текст (900)', hex: '#fff6eb' }
    ]
  },
  {
    id: 'dark-lilac',
    name: 'Темная Сирень 🖤',
    desc: 'Темная версия сиреневой палитры: мистические фиолетово-сливовые фоны и теплый пастельный акцент.',
    colors: [
      { name: 'Фон (50)', hex: '#0f0b0d' },
      { name: 'Карточки (100)', hex: '#1c1218' },
      { name: 'Мягкий акцент (200)', hex: '#33202d' },
      { name: 'Доп. акцент (300)', hex: '#4c2f43' },
      { name: 'Приглушенный текст (400)', hex: '#704764' },
      { name: 'Основной бренд (500)', hex: '#AD7872' },
      { name: 'Ховер бренда (600)', hex: '#9c6660' },
      { name: 'Активный бренд (700)', hex: '#8a5550' },
      { name: 'Темный акцент (800)', hex: '#ebd5e1' },
      { name: 'Основной текст (900)', hex: '#FAF3F1' }
    ]
  },
  {
    id: 'dark-sakura',
    name: 'Темная Сакура 🖤',
    desc: 'Темная версия темы Сакура: глубокий баклажаново-розовый фон с мягким цветущим вишневым брендом.',
    colors: [
      { name: 'Фон (50)', hex: '#100b0c' },
      { name: 'Карточки (100)', hex: '#1d1215' },
      { name: 'Мягкий акцент (200)', hex: '#331e24' },
      { name: 'Доп. акцент (300)', hex: '#4d2d36' },
      { name: 'Приглушенный текст (400)', hex: '#70434f' },
      { name: 'Основной бренд (500)', hex: '#A2747B' },
      { name: 'Ховер бренда (600)', hex: '#8c5f66' },
      { name: 'Активный бренд (700)', hex: '#774d53' },
      { name: 'Темный акцент (800)', hex: '#ebd5d9' },
      { name: 'Основной текст (900)', hex: '#F8F5F6' }
    ]
  },
  {
    id: 'dark-mint',
    name: 'Темная Мята 🖤',
    desc: 'Темная версия мятной палитры: глубокие хвойные и нефритовые оттенки с освежающим мятно-зеленым брендом.',
    colors: [
      { name: 'Фон (50)', hex: '#0b0f0c' },
      { name: 'Карточки (100)', hex: '#121c16' },
      { name: 'Мягкий акцент (200)', hex: '#1e3328' },
      { name: 'Доп. акцент (300)', hex: '#2d4d3c' },
      { name: 'Приглушенный текст (400)', hex: '#437057' },
      { name: 'Основной бренд (500)', hex: '#7CB488' },
      { name: 'Ховер бренда (600)', hex: '#669e72' },
      { name: 'Активный бренд (700)', hex: '#52875d' },
      { name: 'Темный акцент (800)', hex: '#d5ebd9' },
      { name: 'Основной текст (900)', hex: '#FAF4F5' }
    ]
  },
  {
    id: 'dark-autumn',
    name: 'Темная Осень 🖤',
    desc: 'Темная версия осенней палитры: теплый древесный уголь с насыщенным глиняно-оливковым брендом.',
    colors: [
      { name: 'Фон (50)', hex: '#0f0c0b' },
      { name: 'Карточки (100)', hex: '#1c1512' },
      { name: 'Мягкий акцент (200)', hex: '#33241d' },
      { name: 'Доп. акцент (300)', hex: '#4c352a' },
      { name: 'Приглушенный текст (400)', hex: '#70503f' },
      { name: 'Основной бренд (500)', hex: '#8B664F' },
      { name: 'Ховер бренда (600)', hex: '#76543f' },
      { name: 'Активный бренд (700)', hex: '#614331' },
      { name: 'Темный акцент (800)', hex: '#ebdcd5' },
      { name: 'Основной текст (900)', hex: '#FAF3F0' }
    ]
  },
  {
    id: 'dark-peony',
    name: 'Темный Пион 🖤',
    desc: 'Темная версия оригинальной пионовой палитры: глубокий бордово-коричневый фон и яркие неоновые лепестки пиона.',
    colors: [
      { name: 'Фон (50)', hex: '#110b0d' },
      { name: 'Карточки (100)', hex: '#1c1215' },
      { name: 'Мягкий акцент (200)', hex: '#382025' },
  ...
  },
  {
    id: 'dark-peony2',
    name: 'Темный Пион 2 🖤',
    desc: 'Темная версия сбалансированной темы Пеон 2: благородные сливовые фоны с яркими и контрастными розовыми элементами.',
    colors: [
      { name: 'Фон (50)', hex: '#12090b' },
      { name: 'Карточки (100)', hex: '#1e1013' },
      { name: 'Мягкий акцент (200)', hex: '#3a1c22' },
      { name: 'Доп. акцент (300)', hex: '#5a2833' },
      { name: 'Приглушенный текст (400)', hex: '#803847' },
      { name: 'Основной бренд (500)', hex: '#a83950' },
      { name: 'Ховер бренда (600)', hex: '#8f2d41' },
      { name: 'Активный бренд (700)', hex: '#752132' },
      { name: 'Темный акцент (800)', hex: '#ebd5d9' },
      { name: 'Основной текст (900)', hex: '#FCF8F9' }
    ]
  },
  {
    id: 'dark-flamingo',
    name: 'Темный Фламинго 🖤',
    desc: 'Темная версия темы Фламинго: мистический пурпурно-черный фон с изящным сиренево-розовым светящимся брендом.',
    colors: [
      { name: 'Фон (50)', hex: '#0c0708' },
      { name: 'Карточки (100)', hex: '#1a1012' },
      { name: 'Мягкий акцент (200)', hex: '#331a20' },
      { name: 'Доп. акцент (300)', hex: '#4c252f' },
      { name: 'Приглушенный текст (400)', hex: '#703846' },
      { name: 'Основной бренд (500)', hex: '#c685b2' },
      { name: 'Ховер бренда (600)', hex: '#b3719e' },
      { name: 'Активный бренд (700)', hex: '#a05e8a' },
      { name: 'Темный акцент (800)', hex: '#ebd5e5' },
      { name: 'Основной текст (900)', hex: '#F7F2F1' }
    ]
  },
  {
    id: 'dark-marshmallow',
    name: 'Темный Зефир 🖤',
    desc: 'Темная версия палитры Зефирный какао: глубокие сливочно-кофейные фоны с нежными пастельно-зефирными деталями.',
    colors: [
      { name: 'Фон (50)', hex: '#0b090a' },
      { name: 'Карточки (100)', hex: '#1a1417' },
      { name: 'Мягкий акцент (200)', hex: '#33222b' },
      { name: 'Доп. акцент (300)', hex: '#4c3140' },
      { name: 'Приглушенный текст (400)', hex: '#70495f' },
      { name: 'Основной бренд (500)', hex: '#ae84a0' },
      { name: 'Ховер бренда (600)', hex: '#99708c' },
      { name: 'Активный бренд (700)', hex: '#855d78' },
      { name: 'Темный акцент (800)', hex: '#ebd5e4' },
      { name: 'Основной текст (900)', hex: '#FAF6F8' }
    ]
  }
];
